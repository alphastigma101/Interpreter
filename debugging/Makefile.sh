...
g++ -g -std=c++17 -fconcepts scanner.o parser.o interpreter.o context_free_grammar.o abstraction_tree_syntax.o environment.o language_specific_truthy_operations.o language_specific_unary_operations.o language_specific_binary_operations.o token.o  debug_interpreter.o -o exec_debug_interpreter
...
g++ -g -std=c++17 -fconcepts interpreter.o scanner.o parser.o context_free_grammar.o environment.o token.o test_interpreter.o language_specific_binary_operations.o language_specific_unary_operations.o language_specific_truthy_operations.o  -o test_interpreter $LDFLAGS

echo "Compiling main.cc!"
g++ -g -std=c++17 -fconcepts  $INCLUDE -DENABLE_TESTING=1 -DENABLE_LOGGING_TEST=1 -c ../main.cc -o main.o
g++ -g -std=c++17 -fconcepts  interpreter.o scanner.o parser.o context_free_grammar.o abstraction_tree_syntax.o token.o language_specific_binary_operations.o language_specific_unary_operations.o language_specific_truthy_operations.o environment.o main.o -o exec_interpreter